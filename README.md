...
- **Start deleting a reference and the plugin offers to finish it.** Backspace over its closing bracket and a suggestion appears; accept it and the rest of the link is gone. The counterpart to the suggestion that appears once a reference has been typed — same idea at the other end of its life. Nothing is offered while the link is still intact, and this is the route that works on a phone, where the link is rendered rather than shown as source.
