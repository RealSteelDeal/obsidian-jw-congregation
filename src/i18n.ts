...
export const L: Record<SupportedLang, Strings> = {
	de: {
		...
		btnAlignReference: 'Bibelstelle erweitern',
		...
		suggestRemoveScriptureLink: 'Bibelstelle entfernen',
	...
	en: {
		...
		btnAlignReference: 'Extend reference',
		...
		suggestRemoveScriptureLink: 'Remove scripture reference',
	...
	fr: {
		...
		btnAlignReference: 'Étendre la référence',
	...
	it: {
		...
		btnAlignReference: 'Estendi il riferimento',
		...
		suggestRemoveScriptureLink: 'Rimuovi il riferimento biblico',
	...
	pt: {
		...
		suggestRemoveScriptureLink: 'Remover o texto bíblico',
	...
	ru: {
		...
		btnAlignReference: 'Расширить ссылку',
	...
	es: {
		...
		btnAlignReference: 'Ampliar la referencia',
		...
		suggestRemoveScriptureLink: 'Quitar el texto bíblico',
