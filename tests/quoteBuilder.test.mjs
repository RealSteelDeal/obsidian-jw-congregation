...
test('buildScriptureQuoteBlock renders the reference as a jwlibrary link in the callout title', () => {
...
test('buildScriptureQuoteBlock joins multiple verses into one blockquote line, separated by their number', () => {
	const block = buildScriptureQuoteBlock('Psalm 1:1, 2', HREF, [
		verse('1', 'Erster Vers.'),
		verse('2', 'Zweiter Vers.'),
	]);
	assert.equal(block, `> [!quote] [Psalm 1:1, 2](${HREF})\n> 1 Erster Vers. 2 Zweiter Vers.\n`);
});
